...
*/
-- case-sensitive
SELECT REGEXP_REPLACE('ABCDEFGHIJdgij','[DGI]','X',1,0,'c') FROM DUAL;--Result: ABCXEFXHXJdgij
-- ignore-case
SELECT REGEXP_REPLACE('ABCDEFGHIJdgij','[DGI]','X',1,0,'i') FROM DUAL;--Result: ABCXEFXHXJXXXj
